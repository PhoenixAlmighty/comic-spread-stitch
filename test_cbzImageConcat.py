...
class TestCbzImageConcat(unittest.TestCase):
	def test_printSuccess:
		...
		self.assertEqual(capturedOutput.getvalue(), "Test book successfully altered on the back cover.", "Console output is wrong for back cover only.")
		...
		sys.stdout = sys.__stdout__
		self.assertEqual(capturedOutput.getvalue(), "Test book successfully altered on the back cover and page 2.", "Console output is wrong for back cover plus 1 spread.")
		...
		sys.stdout = sys.__stdout__
		self.assertEqual(capturedOutput.getvalue(), "Test book successfully altered on the back cover and pages 2 and 3.", "Console output is wrong for back cover plus 2 spreads.")
		...
		sys.stdout = sys.__stdout__
		self.assertEqual(capturedOutput.getvalue(), "Test book successfully altered on the back cover and pages 2, 3, and 4.", "Console output is wrong for back cover plus 3 spreads.")
		...
		sys.stdout = sys.__stdout__
		self.assertEqual(capturedOutput.getvalue(), "Test book successfully altered on page 2.", "Console output is wrong for 1 spread.")
		...
		sys.stdout = sys.__stdout__
		self.assertEqual(capturedOutput.getvalue(), "Test book successfully altered on pages 2 and 3.", "Console output is wrong for 2 spreads.")
		...
		sys.stdout = sys.__stdout__
		self.assertEqual(capturedOutput.getvalue(), "Test book successfully altered on pages 2, 3, and 4.", "Console output is wrong for 3 spreads.")
	...
	def test_bookDirIsValid:
		...
		self.assertEqual(capturedOutput.getvalue(), "No book directory on this line. Check your input.", "Console output is incorrect for empty string input as book directory.")
		...
		self.assertEqual(capturedOutput.getvalue(), "{} does not exist. Check your filepath.".format(nonexistentDir), "Console output is incorrect for nonexistent book directory.")
	...
	def test_convertPageList:
		...
		self.assertEqual(capturedOutput.getvalue(), "Test book directory has no pages to combine. Check your input.", "Console output is incorrect for empty page list.")
		...
		self.assertEqual(capturedOutput.getvalue(), "Page list for Test book directory contains at least one thing that's not a number. Check your input.", "Console output is incorrect for non-numeric page list.")
